<head>
    ...
    <link href="https://fonts.googleapis.com/css2?family=Tajawal:wght@200;300;400;500;700;800;900&family=Aref+Ruqaa:wght@400;700&display=swap"
        rel="stylesheet">
    ...
    <style>
        ...
        .martyer-font {
            font-size: @lang('helal.martyer-font-size')
        }
    </style>
    <!--====== aos custom ======-->
